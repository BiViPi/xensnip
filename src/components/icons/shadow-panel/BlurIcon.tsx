...
export const BlurIcon = () => {
  ...
  <svg width="20" height="20" viewBox="20 40 216 176">
    ...
    <circle cx="178" cy="128" r="54" fill="none" stroke="var(--icon-accent-blue-light)" strokeWidth="14" opacity="0.15" filter={`url(#${ids.motionBlur})`} />
    <circle cx="148" cy="128" r="54" fill="none" stroke="var(--icon-accent-blue-light)" strokeWidth="14" opacity="0.35" filter={`url(#${ids.motionBlur})`} />
    <circle cx="118" cy="128" r="54" fill="none" stroke="var(--icon-accent-blue)" strokeWidth="14" opacity="0.7" filter={`url(#${ids.motionBlur})`} />
